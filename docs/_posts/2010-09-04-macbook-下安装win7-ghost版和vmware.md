...
<p>买了一台MacBook Pro 372，作为给自己的生日礼物吧。</p>

<p>买的时候让店里的人给装了个BootCamp的XP，回来还是想试试装Win7，但我的Win7是个ghost版的，于是试啊试的，终于被安装上了。</p>

<p>1 在Mac里面启动BootCamp助理，开始安装。<br/>2 用光盘启动后，执行里面的ghost，复制分区到Windows分区。<br/>3 复制完成后，直接想启动Windows分区，是无法启动的。原因应该是启动缺省用的是分区1，但在BootCamp里面，Windows分区是分区3。<br/>4 仍然用光盘启动，进入WinPE，进行分区表修复<br/>5 这时候再启动Windows分区就能启动了<br/>6 插入MacOS的光盘，安装驱动程序。<br/></p>
