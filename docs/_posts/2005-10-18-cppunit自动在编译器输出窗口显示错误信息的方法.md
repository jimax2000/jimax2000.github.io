---
layout: post
title: "CPPUNIT自动在编译器输出窗口显示错误信息的方法"
date: 2005-10-18
tags: [技术]
---
...
// Change the default outputter to a compiler error format outputterrunner.setOutputter( new CompilerOutputter( &amp;runner.result(),  std::cerr ) );（相应还需要#include &lt;cppunit/CompilerOutputter.h&gt; ）
